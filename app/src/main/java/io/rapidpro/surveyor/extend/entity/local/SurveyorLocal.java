...
public class SurveyorLocal {
    ...
    public SurveyorLocal(int primaryKey, int id, int ureport_id, String flow_id, String data_pack, String my_pack, String en_pack, String bn_pack, String data_category, String my_category, String en_category, int status, String created_at, String updated_at) {
